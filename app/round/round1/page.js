...
//     router.push("/round/round1/page1");
//   };
...
//           border: "8px solid",
//           borderImageSource:
//             "linear-gradient(112.72deg, #A89AFC 30.87%, rgba(255, 255, 255, 0) 64.76%)",
//           borderImageSlice: 1,
//           borderRadius: "16px",
//         }}
//       >
//         {/* Header */}
//         <div className="text-3xl font-bold">FUTUREPRENEURS 10.0</div>
//         <div
//           className="py-[6%] text-5xl font-extrabold"
//           style={{
//             background:
//               "linear-gradient(180deg, #FFE35B 34.65%, #FFBA4C 77.17%)",
...
//             border: "2.84px solid",
//             borderImageSource:
//               "linear-gradient(101.11deg, #DAC9FF 38.45%, rgba(148, 120, 153, 0) 86.99%)",
//             borderImageSlice: 1,
//           }}
//         >
//           Continue
