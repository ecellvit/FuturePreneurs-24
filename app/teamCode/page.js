...
const JoinTeam = ({ teamCode: propTeamCode }) => {
  ...
  return (
    <div className=" bg-[url(../assests/assests/bg_website.png)] h-[100vh] w-[100vw] opacity-[85%] flex flex-col items-center justify-around">
      <NavBar/>
        ...
        <div className="flex flex-col gap-4 w-[inherit] justify-around content-center">
          ...
          <form className="flex flex-col justify-center items-center gap-8">
            <input 
              ...
              />
            <button className=" items-center md-7 rounded-3xl w-[30vw] md:w-[20vw] lg:w-[13vw] bg-gradient-to-r from-purple-500 to-blue-500 transition-transform ease-in-out duration-300 hover:scale-110 active:scale-95 bg-blue-500 text-white p-2 border-black"
