...
export default function page() {
  ...
  return (
    <main className="h-[100vh] w-[100vw] flex flex-col items-center justify-center bg-[#FFFFFF] gap-10">
      {loading && <LoadingScreen/>}
      <div className="bg-[#141B2B] h-[80vh] w-[90vw] md:h-[80vh] md:w-[70vw] lg:h-[80vh] lg:w-[30vw] rounded-md flex justify-around  content-around flex-col portrait:lg:w-[90vw] portrait:lg:h-[80vh]">
        ...
        <div className="flex flex-col lg:flex lg:flex-col lg:gap-4 lg:content-around items-center justify-around ">
          <div className="lg:h-[30vh] flex-col justify-evenly  content-center border w-[50vw] lg:w-[20vw]">
            <h1 className="text-center md:w-[50vw] border text-[4vh] py-5 text-[#FFFFFF]">Join your team</h1>
          ...
          <div className="lg:w-[25vw] w-[70vw] border-2 border-[#D9D9D9] rounded-lg "></div>
          <div className="lg:h-[25vh] flex-col justify-center  content-center lg:w-[25vw]">
            ...
            <div className="flex flex-col justify-evenly items-center gap-5">
              <input
                type="text"
                placeholder="Enter team name"
                className="  md:max-w-[40vw] portrait:md:max-w-[40vw] portrait:lg:w-[30vw] portrait:lg:text-l lg:w-[15vw] h-[5vh] w-[55vw]  rounded-md text-l text-slate-900  focus:outline-none focus:placeholder-transparent active:scale-95 transition-all duration-300"
      ...
      <button className="mb-7 sm:landscape:w-[15vw]  rounded-3xl bg-gradient-to-r from-[#03A3FE] to-[#00FFA3] text-center portrait:lg:w-[30vw]  md:max-w-[25vw] md:text-[1.6vh]  sm:landscape:md:text-[1.7vh] lg:w-[15vw] w-[50vw] h-[5vh] hover:scale-110 active:scale-95 transition-transform ease-in-out duration-300">I don't have a team</button>
    </main>
  );
}
